...
import { NEWPASSWORDSCREEN } from '../../routers/ScreenNames'
...
export default (props) => {
    ...
    const onSubmit = (data) => {
    navigate.navigate(NEWPASSWORDSCREEN);
    console.log(data);
    };
    ...
    return (
        <View style={{flex: 1, backgroundColor: R.colors.white }}>
            ...
            <View style={{flex: 0.5, paddingHorizontal: 32}}>
                ...
                <Text style={{color: R.colors.gray1, marginVertical: 18}}>An OTP code sent to your phone. Enter it here: </Text>
                <Controller
                    control={control}
                    rules={{
                        required: true,
